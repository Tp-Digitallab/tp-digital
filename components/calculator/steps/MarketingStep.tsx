...
const copy = {
  de: {
    description:
      "Enthaltene Leistungen sind bereits im Preis berücksichtigt. Weitere Leistungen können Sie bei Bedarf ergänzen.",
    included: "Im Preis enthalten",
  },
  en: {
    description:
      "Included services are already covered by the price. Add other services only if you need them.",
    included: "Included in the price",
  },
  ru: {
    description:
      "Включённые услуги уже учтены в стоимости. Остальные можно добавить, если они вам нужны.",
...
export default function MarketingStep({
  ...
  const t = translations[language].calculatorSteps.marketing;
      ...
      <div className="mt-8 space-y-4">
        {marketing.map((item) => {
          const included =
            ...
            ("included" in item && item.included === true);
